...
use crate::projection::{
    AggregateOffsets, Offset, PersistenceId, ProjectionError, META_PERSISTENCE_ID,
    META_PROJECTION_NAME, META_VIEW_TABLE,
};
...
//                 cause: err.into(),
//                 meta: maplit::hashmap! {
//                     META_VIEW_TABLE.to_string() => self.offset_storage_table.to_string(),
...
//         let save_result =
//             actor::protocol::save_offset(&self.storage, projection_name, persistence_id, offset)
//                 .await
//                 .map_err(|err| ProjectionError::Storage {
//                     cause: err.into(),
//                     meta: maplit::hashmap! {
...
//
// mod actor {
//     use crate::postgres::offset::actor::protocol::{LoadAllOffsets, LoadOffset, SaveOffset};
...
//             let command = SaveOffset::new(projection_name, persistence_id.clone(), current_offset);
//             actor.send(command).await?
//         }
//
//         #[derive(Debug)]
...
//
//     #[async_trait]
//     impl Handler<LoadAllOffsets> for PostgresOffsetStorageActor {
...
//                 error!(%projection_name, %persistence_id, %offset, "postgres offset storage failed to commit save offset transaction: {error:?}");
...
//             Self {
//                 offset_storage_table: SmolStr::new(offset_storage_table),
//                 select_all: OnceCell::new(),
//                 select: OnceCell::new(),
//                 update_or_insert: OnceCell::new(),
//             }
//         }
//
//         fn where_projection(&self) -> String {
//             format!(
//                 "{projection_id} = $1",
...
//         }
//
//         fn where_projection_and_aggregate(&self) -> String {
//             format!(
