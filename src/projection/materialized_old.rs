// use super::{OffsetStorageRef, ProjectionError};
// use crate::projection::materialized::ViewContext;
...
// // pub struct GenericViewProcessor<V, E>
// // where
// //     V: View + Send,
// //     E: Send + Sync,
// // {
// //     aggregate_storage: JournalStorageRef,
// //     offset_storage: OffsetStorageRef,
// //     error_handler: Option<Box<ProcessorErrorHandler>>,
// //     _marker: PhantomData<E>,
// // }
// //
// // impl<V, E> fmt::Debug for GenericViewProcessor<V, E>
// // where
// //     V: View + Send,
// //     E: Send + Sync,
// // {
...
// // }
// //
// // impl<V, E> GenericViewProcessor<V, E>
// // where
// //     V: View + Send,
// //     E: Send + Sync,
// // {
// //     pub fn new(aggregate_storage: JournalStorageRef, offset_storage: OffsetStorageRef) -> Self {
// //         Self {
// //             aggregate_storage,
// //             offset_storage,
// //             error_handler: None,
...
// //     }
// //
// //     pub fn from_system(system: &ActorSystem) -> Result<Self, ProjectionError> {
// //         let persistence = system.persistence();
// //         let aggregate_storage = <V as View>
// //     }
// //
...
// //     ///
// //     /// ```
// //     /// # use coerce_cqrs::GenericViewProcessor;
// //     /// # async fn config(mut processor: GenericViewProcessor<MyViewRepository,MyView,MyAggregate>) {
// //     /// let view = processor.load("customer-B24DA0").await;
// //     /// # }
// //     /// ```
// //     pub async fn load(&self, persistence_id: &str) -> Option<V> {
// //         // let foo = self.aggregate_storage.
// //
...
// //
// // #[async_trait]
// // impl<R, V, E> EventProcessor<E> for GenericViewProcessor<R, V, E>
// // where
...
// //
// // #[async_trait]
// // impl<R, V, E> ApplyViewEvents<R, E> for GenericViewProcessor<R, V, E>
// // where
// //     R: ViewRepository<View = V> + Send + Sync,
// //     V: View<E> + Default + Send,
// //     E: Send + Sync,
